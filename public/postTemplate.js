...
templates['postTemplate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<article class=\"post\">\r\n        <button type=\"button\" class=\"hide-post-button\"><i class=\"fas fa-chevron-up\"></i></button>\r\n        <div class=\"post-content visible\">\r\n\r\n          <p class=\"post-text\">\r\n            "
    + container.escapeExpression(((helper = (helper = helpers.postContent || (depth0 != null ? depth0.postContent : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"postContent","hash":{},"data":data}) : helper)))
